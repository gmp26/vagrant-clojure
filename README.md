# Vagrant Box Provisioning for a Clojure Environment
...
```
vagrant package --output pkg/clojure.box
vagrant box add --name clojure pkg/clojure.box
```
...
```
vagrant init ychaker/clojure; vagrant up --provider virtualbox
